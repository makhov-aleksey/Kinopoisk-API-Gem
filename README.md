...
* **kinopoisk** - Массив следующих данных для КиноПоиск:
    ...
    * **film_critics_in_percentage** - Рейтинг критиков в мире в процентах
    * **film_critics** - Количество оценок критиков в мире
    * **rf_critics_in_percentage** - Рейтинг критиков в РФ в процентах
    * **rf_critics** - Количество оценок критиков в РФ
